...
if __name__ == '__main__':
    ...
    for entity in entities:
        ...
        if entity_name == "envase_dispensado":
            query_years = "select distinct YEAR(fecha_dispensacion_dt) as years from main.envase_dispensado where YEAR(fecha_dispensacion_dt) >= 2017 order by YEAR(fecha_dispensacion_dt) ASC"

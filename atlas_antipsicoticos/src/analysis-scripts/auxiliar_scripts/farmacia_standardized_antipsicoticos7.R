...
for(variable_indicator in c('ddd_por_envase','pvp_nomenclator_nm')){
  ...
  for(año in lista_años){
    ...
    indicators_list <- c("N05AA01","N05AA02","N05AB02","N05AB03","N05AC01","N05AC04","N05AD01",
                         "N05AE03","N05AE04","N05AE05","N05AF05","N05AG02","N05AH02","N05AH03",
                         "N05AH04","N05AH05","N05AH06","N05AL03","N05AL05","N05AL07","N05AX08",
                         "N05AX12","N05AX13","N05AX15","N05AX16","N05AL01","N05AN01")

...
- __docs/CDM/__
  ...
  - **synthetic-data/**: Folder structure contaning an automatically generated set of synthetic records per entity included en the CDM.

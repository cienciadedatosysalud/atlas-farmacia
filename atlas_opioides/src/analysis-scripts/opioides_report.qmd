...
write.table(df, file = paste0(outputs_path,"opioides_indicators_rates.csv"),
            row.names = FALSE,  sep = '|')
...
data <- read.csv('../../outputs/opioides_indicators_rates.csv', sep = "|",colClasses=c("codatzbs"="character"))

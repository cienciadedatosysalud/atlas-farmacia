...
, n.ddd_nomenclator_nm, n.ddd_por_envase, n.pvp_nomenclator_nm, n.precio_por_envase_nm, n.mme_total  FROM (SELECT * from main.envase_dispensado 
...
El nomenclator usado como referencia para todos los años es el nomenclator del Ministerio de Sanidad (septiembre 2025) para todas las CCAA en el que se han modificado los DDD de los fármacos combinados para especificar el DDD del fármaco de interés (opioides). 
...
plot <- ggplot(df_,
  ...
  scale_fill_manual(values = c("N02AA"="#66c2a5", "N02AB"="#fc8d62", "N02AE"="#8da0cb", "N02AJ"='#e78ac3', "N02AX"='#a6d854')) +

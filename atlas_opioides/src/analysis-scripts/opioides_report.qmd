...
write.csv(df, file = paste0(outputs_path,"opioides_estadisticosobs.csv"),
            row.names = FALSE)
...
write.csv(df, file = paste0(outputs_path,"opioides_indicators_rates.csv"),
            row.names = FALSE)

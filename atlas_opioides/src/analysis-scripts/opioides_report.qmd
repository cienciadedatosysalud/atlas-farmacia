...
write.table(df, file = paste0(outputs_path,"opioides_dhd_pvp_population_values.csv"),
            row.names = FALSE,  sep = '|')
...
write.table(df_, file = paste0(outputs_path,"opioides_dhd_pvp_resumen_anual.csv"),
            row.names = FALSE,  sep = '|')
```
...
consumo_zbs_total_ <- read.csv('../../outputs/opioides_dhd_pvp_population_values.csv', sep = '|')
...
data <- read.csv('../../outputs/opioides_dhd_pvp_population_values.csv', sep = "|",colClasses=c("codatzbs"="character"))

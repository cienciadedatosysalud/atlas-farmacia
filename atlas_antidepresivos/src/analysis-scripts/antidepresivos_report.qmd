...
list_atc_4 <- data.frame(codigo = c('N06AA','N06AB','N06AF','N06AG','N06AX'),
...
plot_evo_temp_atc_nenv[[3]]$N06AF
```
...
plot_evo_temp_atc_nenv[[4]]$N06AG
```
...
plot_evo_temp_atc_nenv[[5]]$N06AX
```
